...
<template>
    <GuestLayout>
        ...
        <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
            ...
            acabamos de enviar? Se você não recebeu o email, teremos prazer em enviar outro.
        </div>

        <div class="mb-4 font-medium text-sm text-green-600 dark:text-green-400" v-if="verificationLinkSent">
            Um novo link de verificação foi enviado para o endereço de email que você forneceu no registro.
        </div>
